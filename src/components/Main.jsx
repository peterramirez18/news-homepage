      ...
      <div className='flex flex-col xl:flex-row gap-x-8 '>
        ...
        <div className='flex flex-col'>
          ...
          <div className='grid gap-x-7 grid-cols-1 md:grid-cols-2 mt-8'>
            <h1 className='font-black w-[11ch] md:w-[8ch] text-[3rem] md:text-[3.5rem] leading-[3.6rem] text-very-dark-blue dark:text-off-white'>The Bright Future of Web 3.0?</h1>
            <div className='mb-10 xl:mb-0'>
              <p className='text-sm md:text-base mt-4 md:mt-0'>
                We dive into the next evolution of the web that claims to put the power of the platforms back into the hands of the people.
                But is it really fulfilling its promise?
              </p>
              <button className=' mt-8 font-semibold bg-red hover:bg-very-dark-blue dark:hover:bg-orange text-sm tracking-[0.2rem] px-10 p-4 text-white'>READ MORE</button>
            </div>
          </div>
        </div>
        ...
        {/* right */}
        <div className=' bg-very-dark-blue dark:bg-off-white/5 text-white w-full xl:w-[1040px] pb-9 xl:pl-6 pl-0 p-6 mt-12 md:mt-0'>
